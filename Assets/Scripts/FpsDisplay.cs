...
// https://github.com/Microsoft/MixedRealityToolkit-Unity/blob/v1.2017.1.2/Assets/HoloToolkit/Utilities/Scripts/FpsDisplay.cs
//
// Copyright (c) Microsoft Corporation. All rights reserved.
// Licensed under the MIT License. See LICENSE in the project root for license information.
// https://github.com/Microsoft/MixedRealityToolkit-Unity/blob/v1.2017.1.2/License.txt
...
namespace HoloToolkit.Unity
{
    ...
    public class FpsDisplay : MonoBehaviour
    {
        ...
        private void UpdateTextDisplay(int fps)
        {
            ...
            string displayString = "FPS: " + StringsFrom00To99[Mathf.Clamp(fps, 0, 99)];
